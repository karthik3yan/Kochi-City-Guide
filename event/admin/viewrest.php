                    ...
                    <div class="col-xl-10">
                                    ...
                                    <div class="page-breadcrumb">
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb">
                                                ...
                                                <li class="breadcrumb-item"><a href="viewrest.php" class="breadcrumb-link">All Restaurants</a></li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
                        ...
                        <!-- ============================================================== -->
                         ...
                         <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            ...
                            <div class="card">
                                <h5 class="card-header">List of Restaurants</h5>
                                <div class="card-body">
                                     <table class="table">
                                        <thead>
                                            <tr>
   ...
   $conn = mysqli_connect('localhost',$dbhost, $dbuser, $dbpass);
            ...
            ?>           
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="deleterest.php?rid=<?php echo $rws['rid'];?>">
