...
<h5>Admin</h5>
                                    ...
                                    <div class="page-breadcrumb">
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb">
                                                ...
                                                <li class="breadcrumb-item"><a href="viewpromo.php" class="breadcrumb-link">Promo Codes</a></li>
                                                <li class="breadcrumb-item"><a href="addpromo.php" class="breadcrumb-link">Add Promo Code</a></li>
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="section-block" id="basicform">
                                    <h3 class="section-title">Add New Promo Code</h3>
  ...
  echo"<form method=\"post\" action=\"insertingpromo.php\">";
     
           
          ?>
                                            <div class="form-group">
                                                <label for="title" class="col-form-label">Promo Title</label>
                                                <input id="title" name="title" type="text" class="form-control">
                                            
                                                <label for="details">Promo Details</label>
                                                <textarea class="form-control" name="details" id="details" rows="3"></textarea>
                                                   <label for="by" class="col-form-label">Promo By:</label>
                                                <input id="by" name="by" type="text" class="form-control">
                                                 
                                                 <label for="code" class="col-form-label">Code</label>
                                                <input id="code" name="code" type="text" class="form-control"><br>
                                                
                                                
                                                   Expiry Date : <input type="date" id="date" name="date" > &nbsp;&nbsp;  
                                            
                                                 <input type="submit"  value="Add !"  class="btn btn-primary"  name="request">
                                            </div>
