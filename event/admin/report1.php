...
<h5>Admin</h5>
                    ...
                    <div class="col-xl-10">
                                    ...
                                    <div class="page-breadcrumb">
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb">
                                                ...
                                                <li class="breadcrumb-item"><a href="report1.php" class="breadcrumb-link">Report1</a></li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
                        ...
                        <!-- ============================================================== -->
                         ...
                         <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            ...
                            <div class="card">
                                <h5 class="card-header">List of Events and List of People Interested in a Particular Event</h5>
                                <div class="card-body">
                                    <table class="table">
                                        <thead>
                                            <tr>
   ...
   $conn = mysqli_connect('localhost',$dbhost, $dbuser, $dbpass);
            ...
            ?>           
                                            ...
                                            <tr>
                                                <th scope="row"><?php echo $rws['eid'];?></th>
                                                <td><?php echo $rws['ename'];?></td>
                                                <td><?php echo $rws['date'];?></td>
                                                <td><?php echo $rws['interests'];?></td>
                                                <td>
                                                    <a href="interestreport.php?eid=<?php echo $rws['eid'];?>">
