...
<h5>Admin</h5>
                    ...
                    <div class="col-xl-10">
                                    ...
                                    <div class="page-breadcrumb">
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb">
                                                ...
                                                <li class="breadcrumb-item"><a href="viewevent.php" class="breadcrumb-link">Events</a></li>
                                                <li class="breadcrumb-item"><a href="eventrequest.php" class="breadcrumb-link">Event Requests</a></li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
                        ...
                        <!-- ============================================================== -->
                         ...
                         <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            ...
                            <div class="card">
                                <h5 class="card-header">List of Events Requested</h5>
                                <div class="card-body">
                                    <table class="table">
                                        <thead>
                                            <tr>
   ...
   $conn = mysqli_connect('localhost',$dbhost, $dbuser, $dbpass);
            ...
            ?>           
                                            ...
                                            <tr>
                                                <th scope="row"><?php echo $rws['erid'];?></th>
                                                <td><?php echo $rws['ename'];?></td>
                                                   <td><?php echo $rws['edetail'];?></td>
                                                <td><?php echo $rws['date'];?></td>
                                                <td><?php echo $rws['user'];?></td>
                                                <td><?php echo $rws['charge'];?></td>
                                                
                                                
                                                
                                                <td>
                                                    <a href="accepteventrequest.php?erid=<?php echo $rws['erid'];?>">
                                                 <button class="btn btn-sm btn-outline-light">
                                                <i class="fas fa-check"></i>
                                                        </button></a>
                                                    <a href="deleteeventrequest.php?erid=<?php echo $rws['erid'];?>">
                                                 <button class="btn btn-sm btn-outline-light">
