...
<h5>Admin</h5>
                                    ...
                                    <div class="page-breadcrumb">
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb">
                                                ...
                                                <li class="breadcrumb-item"><a href="addevent.php" class="breadcrumb-link">Add Event</a></li>
  ...
  echo"<form method=\"post\" action=\"insertingevent.php\">";
          ...
          ?>
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="details" id="details" rows="3"></textarea>
                                                 ...
                                                 <label for="charge" class="col-form-label">Event charge(in Rs.)</label>
                                                <input id="charge" name="charge" type="text" class="form-control"><br>
