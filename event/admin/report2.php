                    ...
                    <div class="col-xl-10">
                        ...
                        <!-- ============================================================== -->
                         ...
                         <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            ...
                            <div class="card">
                                <h5 class="card-header">List of Restaurants and Booking lists in a particular restaurant with a From and To Filters</h5>
                                <div class="card-body">
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col">Address</th>
                                                  ...
                                                  <th scope="col">Check Bookings</th>
                                            </tr>
                                        </thead>
                                        <tbody>
   ...
   $conn = mysqli_connect('localhost',$dbhost, $dbuser, $dbpass);
            ...
            ?>           
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $rws['aseat'];?></td>
                                                <td><?php echo $rws['address'];?></td>
                                                <td><?php echo $rws['catigory'];?></td>
                                                <td>
                                                    <a href="bookingreport.php?rid=<?php echo $rws['rid'];?>">
