...
<h5>Admin</h5>
                                    ...
                                    <div class="page-breadcrumb">
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb">
                                                ...
                                                <li class="breadcrumb-item"><a href="viewrest.php" class="breadcrumb-link">Restaurants</a></li>
                                                <li class="breadcrumb-item"><a href="addrest.php" class="breadcrumb-link">Add Restaurant</a></li>
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="section-block" id="basicform">
                                    <h3 class="section-title">Add New Restaurant</h3>
  ...
  echo"<form method=\"post\" action=\"insertingrest.php\">";
          ...
          ?>
                                            <div class="form-group">
                                                ...
                                                <input id="cat" name="cat" type="text" class="form-control">
                                                 ...
                                                 <label for="seat" class="col-form-label">Seat Available</label>
                                                <input id="seat" name="seat" type="seat" class="form-control">
                                                <br>
