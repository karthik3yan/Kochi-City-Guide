...
<h5>Admin</h5>
                                    ...
                                    <div class="page-breadcrumb">
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb">
                                                ...
                                                <li class="breadcrumb-item"><a href="viewrest.php" class="breadcrumb-link">Hotels</a></li>
                                                <li class="breadcrumb-item"><a href="addrest.php" class="breadcrumb-link">Add Hotel</a></li>
  ...
  echo"<form method=\"post\" action=\"insertinghotel.php\" enctype=\"multipart/form-data\">";
          ...
          ?>
                                           ...
                                           Upload the Hotels Image :  <input type="file" name="image1" id="image1">
                                                <br>
