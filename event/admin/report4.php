                    ...
                    <div class="col-xl-10">
                                    ...
                                    <div class="page-breadcrumb">
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb">
                                                ...
                                                <li class="breadcrumb-item"><a href="report4.php" class="breadcrumb-link">Report4</a></li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
                        ...
                        <!-- ============================================================== -->
                         ...
                         <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            ...
                            <div class="card">
                                <h5 class="card-header">List of Blogs with sort Option and list of comments on a particular blog</h5>
                                <div class="card-body">
                                    <a href="report4.php?sort=views" class="btn btn-rounded btn-light">Sort by Most Viewed</a>
                                            <a href="report4.php?sort=date" class="btn btn-rounded btn-dark">Sort By Date(Latest)</a><br><br>
                                    <table class="table">
                                        <thead>
                                            <tr>
   ...
   $conn = mysqli_connect('localhost',$dbhost, $dbuser, $dbpass);
            ...
            ?>           
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="commentreport.php?bid=<?php echo $rws['bid'];?>">
