...
<h5>Admin</h5>
                    ...
                    <div class="col-xl-10">
                                    ...
                                    <div class="page-breadcrumb">
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb">
                                                ...
                                                <li class="breadcrumb-item"><a href="report2.php" class="breadcrumb-link">Report2</a></li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
                        ...
                        <!-- ============================================================== -->
                         ...
                         <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            ...
                            <div class="card">
                                <h5 class="card-header">List of People Booked in a Particular Restaurant are:</h5>
                                <div class="card-body">
   ...
   $conn = mysqli_connect('localhost',$dbhost, $dbuser, $dbpass);
						...
						$sel = "SELECT * FROM restobooking where date >= '$fdate' and date <= '$tdate' and rid = $rid";
						$rs = $conn->query($sel);
            ...
            ?>           
                        ...
                        <?php }            
                                              ...
                                              $rid= $_GET['rid'];
                                       echo"<form method=\"post\" action=\"bookingreport.php?rid=".$rid."\">";
        ?>
     <label for="date"> From</label>
          <input type="date" id="fdate" name="fdate" ></input>
                                     <label for="date"> To</label>
          <input type="date" id="tdate" name="tdate" ></input>
