...
<h5>Admin</h5>
                ...
                <div class="row">
                    <div class="col-xl-10">
                                    ...
                                    <div class="page-breadcrumb">
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb">
                                                ...
                                                <li class="breadcrumb-item"><a href="viewhotel.php" class="breadcrumb-link">Hotels</a></li>
                                                <li class="breadcrumb-item"><a href="viewhotel.php" class="breadcrumb-link">All Hotels</a></li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
                        ...
                        <!-- ============================================================== -->
                         ...
                         <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                               <div class="card">
                                <h5 class="card-header">List of Hotel with its Avg review and list of reviews of particular Hotel</h5>
                                <div class="card-body">
                                    <table class="table">
                                        <thead>
                                            <tr>
   ...
   $conn = mysqli_connect('localhost',$dbhost, $dbuser, $dbpass);
						...
						while($rws = $rs->fetch_assoc()){
                            ...
                            $s=0;
                            $c=0;
						$sel1 = "SELECT * FROM reviews where hid= $hid";
						$rs1 = $conn->query($sel1);
            ...
            ?>           
                                            ...
                                            <tr>
                                                <th scope="row"><?php echo $rws['hid'];?></th>
                                                <td><?php echo $rws['hotelname'];?></td>
                                                <td><?php echo $rws['hoteldetails'];?></td>
                                                <td><?php echo $rws['hoteladdress'];?></td>
                                                <td><?php echo $avg;?></td>
                                                 <td>
                                                    <a href="deletehotel.php?hid=<?php echo $rws['hid'];?>">
