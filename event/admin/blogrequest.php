...
<h5>Admin</h5>
                    ...
                    <div class="col-xl-10">
                                    ...
                                    <div class="page-breadcrumb">
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb">
                                                ...
                                                <li class="breadcrumb-item"><a href="blogrequest.php" class="breadcrumb-link">Blog Requests</a></li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
                        ...
                        <!-- ============================================================== -->
                         ...
                         <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            ...
                            <div class="card">
                                <h5 class="card-header">List of Blogs Requested</h5>
                                <div class="card-body">
                                    <table class="table">
                                        <thead>
                                            <tr>
   ...
   $conn = mysqli_connect('localhost',$dbhost, $dbuser, $dbpass);
            ...
            ?>           
                                            ...
                                            <tr>
                                                <th scope="row"><?php echo $rws['brid'];?></th>
                                                <td><?php echo $rws['btitle'];?></td>
                                                   <td><?php echo $rws['bdetail'];?></td>
                                                ...
                                                <td>
                                                    <a href="acceptblogrequest.php?brid=<?php echo $rws['brid'];?>">
                                                 <button class="btn btn-sm btn-outline-light">
                                                <i class="fas fa-check"></i>
                                                        </button></a>
                                                    <a href="deleteblogrequest.php?brid=<?php echo $rws['brid'];?>">
                                                 <button class="btn btn-sm btn-outline-light">
