...
<h5>Admin</h5>
                    ...
                    <div class="col-xl-10">
                                    ...
                                    <div class="page-breadcrumb">
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb">
                                                ...
                                                <li class="breadcrumb-item"><a href="index.php" class="breadcrumb-link">Reports</a></li>
                                                <li class="breadcrumb-item"><a href="report5.php" class="breadcrumb-link">Report5</a></li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
                        ...
                        <!-- ============================================================== -->
                         ...
                         <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            ...
                            <div class="card">
                                <h5 class="card-header">List of PromoCode with Sort by Expirydate and Offer</h5>
                                <div class="card-body">
                                    <a href="report5.php?sort=date" class="btn btn-rounded btn-light">Sort by Expiry Date</a>
                                            <a href="report5.php?sort=offer" class="btn btn-rounded btn-dark">Sort By Offer</a><br><br>
                                    <table class="table">
                                        <thead>
                                            <tr>
   ...
   $conn = mysqli_connect('localhost',$dbhost, $dbuser, $dbpass);
                    ...
                    if(isset($_GET['sort']))
                    {
                        if($_GET['sort']=='offer')
                        {
                            	$sel = "SELECT * FROM prmocode ORDER BY Title desc";
                        }
                        else
                        {
                              	$sel = "SELECT * FROM prmocode ORDER BY expdate desc";
                        }
                        
                    }                        
                          else{                  
						$sel = "SELECT * FROM prmocode";
            ...
            ?>           
                                            ...
                                            <tr>
                                                 <th scope="row"><?php echo $rws['pcid'];?></th>
                                                <td><?php echo $rws['Title'];?></td>
                                                <td><?php echo $rws['by'];?></td>
                                                <td><?php echo $rws['code'];?></td>
                                                <td><?php echo $rws['expdate'];?></td>
                                            </tr>
